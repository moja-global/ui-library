import ModalComponent from '../components/ModalBox/ModalBox.vue';
import CardComponent from '../components/Card/Card.vue';
import BoxAlert from '../components/ModalBox/BoxAlert.vue';
import { useBoxAlert } from '../components/ModalBox/BoxAlert.js'
import { ref } from 'vue'
...
export const ModalCard = () => ({
    ...
    template: '<div><button @click="toggle">Toggle</button><div v-show="isModal"><ModalComponent :toggle="toggle"><CardComponent><p> Trial Text Trial Text</p><p>Trial Text Trial Text</p><p> Trial Text Trial Text</p> </CardComponent></ModalComponent></div></div>'
